...
(() => {
    ...
    function handleJoystickMove(e) {
        ...
        const limitedDist = Math.min(dist, maxJoystickDistance);
        ...
        touchState.joystickY = moveY / maxJoystickDistance;
    }
    ...
    function update() {
        ...
        game.bossBullets.forEach(bullet => {
            ...
            if (p.invincible <= 0 && circlesCollide(bullet, p, bullet.size, 15)) {
    ...
    $('hangar-back-btn').addEventListener('click', goToMenu);
    $('merchant-close-btn').addEventListener('click', closeMerchant);
